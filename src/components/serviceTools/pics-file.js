...
function PicsFiles({ toolsId, attachments }) {
  ...
  const handleFilesData = (e) => {
    ...
    if (editFlag && newFileFlag) {
      ...
      axios({
        method: "patch",
        url: `${apiPath.prodPath}/api/serviceTools/editFiles/${toolsId}`,
        data: formData,
      ...
      axios({
        method: "patch",
        url: `${apiPath.prodPath}/api/serviceTools/addFiles/${toolsId}`,
        data: formData,
        withCredentials: false,
        headers: { "Content-Type": "multipart/form-data" },
      })
  ...
  const deletePic = (data) => {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        axios({
          method: "patch",
          url: `${apiPath.prodPath}/api/serviceTools/delFiles/${toolsId}&&${data.id}`,
          data: dataObj,
          withCredentials: false,
          headers: { "Content-Type": "multipart/form-data" },
        })
