...
export async function POST(request) {
  try {
    ...
    const { data, error } = await resend.emails.send({
      ...
      subject: "Sub Task Updated From App",
      html: `<div>
        <p>Sub task has been updated. Please login to the app and see the details of the Sub task</p>
        ...
        <h2>Note:</h2>
        <p>This updated sub-task is against the Task</p>
        <p><strong>Task Category</strong></p>
