...
import PartsItems from "../../serviceTools/parts-items";
import "./style.scss";
import PicsFiles from "../../serviceTools/pics-file";
import HistoryTab from "../../serviceTools/history";
const poppins = Poppins({
  weight: ["300", "400", "600", "700"],
  subsets: ["latin"],
});
function ServiceToolsInfo({ open, onClose, item, refreshData }) {
  ...
  return (
    ...
    >
      ...
      <div className={`${poppins.className} innerTabsWrap`}>
        ...
        {activeTab == "History" ? <HistoryTab toolsInfo={item} /> : null}
      </div>
    </Drawer>
  );
}

export default ServiceToolsInfo;
