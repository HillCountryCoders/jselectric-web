...
export async function POST(request) {
  try {
    ...
    const { data, error } = await resend.emails.send({
      ...
      subject: "Update Task Notification From App",
      html: `<div>
      <p>The task that was assigned To you has been updated. Please login to the app and see the details of the task</p>
